...
# testingDataSet1 = trainingDatatset("DataMining/Neural_Network/testingDataset1.txt")
...
def forwardPropagation():
    ...
    trainingDataset1 = trainingDatatset("DataMining/Neural_Network/trainingDataset1.txt");
...
def results():
    FirstOutputs = [0 for i in range(len(trainingDatatset1))]
    secondOutputs = [0 for i in range(len(trainingDatatset1))]
    i = 0;
    ...
    while(rowForFirstDataset < len(trainingDatatset1)):  
        ...
        for row in Initial_Array2:
            print(row)
        FirstOutputs = Initial_Array2[5][1]
        secondOutputs = Initial_Array2[6][1]
        print("###############################################")
        print("###############################################")
        
        rowForFirstDataset += 1;
        if((rowForFirstDataset + 1) <= len(trainingDatatset1)):
            inputX = float(trainingDatatset1[rowForFirstDataset][1])
            inputY = float(trainingDatatset1[rowForFirstDataset][2])

        # print(FirstOutputs)
        # print(secondOutputs)
    

for roe in trainingDatatset1:
    print(row)
