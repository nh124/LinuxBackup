...
class player{
    player(image, SpriteCol, SpriteWidth, SpriteRow, SpriteHeight, SpriteX, SpriteY,){
    ...
    draw(){
        ...
        ctx.draw(this.image, this.SpriteCol*this.SpriteWidth, this.SpriteRow*this.SpriteHeight, this.SpriteWidth, SpriteHeight, SpriteX, SpriteY,this.SpriteWidth, this.SpriteHeight);
    }
...
const player1 = new player(SpriteImage, SpriteCol * SpriteWidth, SpriteRow * SpriteHeight, SpriteWidth, SpriteHeight, SpriteX, SpriteY, SpriteWidth, SpriteHeight);
